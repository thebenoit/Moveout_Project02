...
<template>
  ...
  <nav class="fixed w-full z-20 top-0 start-0 bg-opacity-60 bg-gray-500 backdrop-blur-3xl text-white">
  ...
  <div class="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
      <button type="button" class="text-white bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Get started</button>
  ...
  <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1 content-center" id="navbar-sticky">
    <ul class="flex flex-col p-4 md:p-0 rounded-lg md:space-x-8 rtl:space-x-reverse md:flex-row">
      ...
      <li>
        <RouterLink to="/aboutus" class="block py-2 px-3 text-gray-900 rounded hover:text-gray-200 md:p-0">
          About-us
          </RouterLink>
      </li>
      <li>
