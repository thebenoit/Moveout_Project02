...
const showNavbar = computed(() => {
  ...
  //masquer la barre navigation sur la page landing page
  return this.route.path!== '/landingpage'
    ...
    <nav   class="fixed w-full z-20 top-0 start-0 bg-opacity-60 bg-gray-600 backdrop-blur-xl text-white">
      <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-3">
        ...
        <div class="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
          <button type="button"
            class="text-white focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center bg-cyan-400 border-none hover:shadow-cyan-400 transition-all time shadow-cyan-200 shadow-lg">Get
            started</button>
        ...
        <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1 content-center"
          id="navbar-sticky">
