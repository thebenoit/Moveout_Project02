<template>
    <div class="w-full min-h-screen grid lg:grid-cols-2">
      <div class="mx-auto max-w-sm content-center">
        <div class="bg-gray-200 backdrop-blur-3xl mt-16 lg:mt-0 p-6 rounded-lg shadow-lg">
            ...
            <div class="grid gap-4 lesInput">
              <div class="grid grid-cols-2 gap-4">
                <div class="grid gap-2  ">
                  <input id="first-name" placeholder="First name" required v-model="form.firstName"/>
                </div>
                <div class="grid gap-2">
                  <input id="last-name" placeholder="Last name" required v-model="form.lastName"/>
                </div>
              </div>
              <div class="grid mt-1">
                <input id="phone" type="phone" placeholder="Phone number" required v-model="form.phone"/>
              </div>
              <div class="grid mt-1">
                <input id="email" type="email" placeholder="Email" required v-model="form.email"/>
              </div>
              <div class="grid mt-1">
                <input id="confirmEmail" type="email" placeholder="Confirm email" required v-model="form.confirmEmail"/>
              </div>
              <div class="grid mt-1">
                <input id="password" type="password" placeholder="Password" required v-model="form.password"/>
              </div>
              <div class="grid mt-1">
                <input id="confirmPassword" type="password" placeholder="Confirm Password" required v-model="form.confirmPassword"/>
              </div>
